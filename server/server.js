...
// ==========================================
// VERCEL SERVERLESS DB MIDDLEWARE
// ==========================================
// Ye guarantee dega ki koi bhi API run hone se pehle DB ready ho, buffering error ko rokega.
app.use(async (req, res, next) => {
    // Sirf /api se shuru hone wale routes ke liye hi DB connect karein (static files ke liye zaroorat nahi)
...
// Global error handler — improved for debugging
app.use((err, req, res, next) => {
    // Log the full error to your server console (Render/Vercel logs)
    console.error('SERVER_ERROR_LOG:', {
        message: err.message,
        stack: err.stack,
        origin: req.headers.origin
...
// Yahan se connectDB() hata diya gaya hai kyunki ab wo middleware mein call ho raha hai
